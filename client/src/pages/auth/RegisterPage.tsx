...
import { isStrongPassword, getPasswordStrength } from "@/utils/validatePassword";
...
const RegisterPage = () => {
  ...
  const { registerCustomer, registerSeller, isAuthenticated } = useAuth();
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      const requestData = {
        ...
        ...(userType === "customer" ? { address: formData.address } : {}),
        ...(userType === "seller" ? {
      ...
      if (userType === "customer") {
        await registerCustomer(requestData);
      } else {
        await registerSeller(requestData);
      }
